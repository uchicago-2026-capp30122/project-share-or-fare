...
def test_join_output():
    ...
    expected_long = rideshare_df[rideshare_df["group_id"] == sample_id]["Pickup Centroid Longitude"].iloc[0]
    actual_long = merged_df[merged_df["group_id"] == sample_id]["Pickup Centroid Longitude"].iloc[0]

...
def neighborhood():
    ...
    for _, row in filtered_neighborhood_routes.iterrows():
        ...
        features.append({
            "type": "Feature",
            "properties": {"line_weight": row["line_weight"],
                           "opacity": row["opacity"],
                           "color": row["tripDiffTimeColor"],
...
def index():
    ...
    click_handler_script = f"""
        ...
        document.addEventListener('DOMContentLoaded', function() {{
            // Wait for Leaflet layers to be ready
            setTimeout(function() {{
                {on_each_feature}
                // Apply to all vector layers on the map
    ...
    function styleByFeatureType(feature) {
        return {
            ...
            weight: feature.properties.line_weight*5,
    ...
    setTimeout(function() {
        ...
        // Loop through layers already on the map
                        ...
                        .then(data => {
                            ...
                            currentRoutesLayer = L.geoJSON(data.routes, {
                                ...
                                onEachFeature: function(feature, layer) {
                                    ...
                                    // Customize tooltip content using route properties

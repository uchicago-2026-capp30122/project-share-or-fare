...
def filter_neighborhood(neighborhood):
    ...
    filtered_neighborhood_routes["perc_rides"] = round(
        (
            filtered_neighborhood_routes["Count"]
            / filtered_neighborhood_routes["Count"].sum()
        )
        * 100,
        2,
    )
    ...
    filtered_neighborhood_routes["line_weight"] = standardize(
        filtered_neighborhood_routes["perc_rides"]
    )
        ...
        features.append(
            {
                "type": "Feature",
                "properties": {
                    "line_weight": (row["line_weight"] * 5) + 1,
                    "opacity": 1,
                ...
                "geometry": {
                    ...
                    "coordinates": [
                        [
                            pickup_poly.centroid.x,
                            pickup_poly.centroid.y,
                        ],  # GeoJSON is [lon, lat]
...
def update_panel(n):
    ...
    avg_tripDiffRatio = str(
        round(
            np.average(
                filtered_neighborhood_routes["transitPenalty_wavg"],
    ...
    avg_tripCost = str(
        round(
            np.average(
                filtered_neighborhood_routes["tripCost_wavg"],
                weights=filtered_neighborhood_routes["Count"],
            ),
            2,
        )
        ...
        html.Div(
            [
                ...
                html.Div(
                    [
                        html.H1(
                            "Share or Fare? A comparison of ride share usage and transit routes in Chicago",
                            style={"margin": "0", "color": "white", "fontSize": "24px"},
                        ),
                        html.P(
                            "Molly Long, Sabrina Wang, Sarah Zebar, Waleed Shahzad",
                            style={"margin": "0", "color": "white", "fontSize": "16px"},
                        ),
                        html.P(
                            "CAPP 30122 Winter 2026",
                            style={"margin": "0", "color": "white", "fontSize": "16px"},
                        ),
                    ],
                    style={
                ...
                # Footer
                html.P(
                    "Sources: Chicago Data Portal (2025) and Google Routes API",
                    style={"color": "black"},
                ),
            ],
            style={
            ...
            [
                ...
                html.Div(
                    [
                        ...
                        html.Div(
                            id="panel-content", children="No neighborhood selected"
                        ),
                    ],
                    style={
                ...
                html.Div(
                    [
                        ...
                        html.P(
                            dcc.Markdown("""**Transit Penalty Score** is the average ratio of transit time to
